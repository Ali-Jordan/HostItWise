...
const serviceLinks = [
  ...
  { label: 'Reputation Growth',      path: '/services' },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <Link to="/" className="inline-block">
              <img src="/logo.png" alt="HostItWise" className="h-20 w-auto" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {serviceLinks.map((link) => (
                <li key={link.label}>
                  <Link to={link.path} className="text-sm text-white/50 hover:text-white transition-colors duration-200">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <Link to="/contact" className="inline-flex items-center justify-center px-5 py-2.5 bg-teal text-white text-sm font-semibold rounded-button hover:bg-teal-hover transition-colors">
              Book Free Audit
            </Link>
          </div>
        </div>
